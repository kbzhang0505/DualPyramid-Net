...
class yolov5_heatmap:
    ...
    def process(self, img_path, save_path):
        ...
        tensor = torch.from_numpy(np.transpose(img, axes=[2, 0, 1])).unsqueeze(0).to(self.device)  # 将输入数据移到指定设备
    ...
    def __call__(self, img_path, save_path):
        ...
        if os.path.isdir(img_path):
            ...
            self.process(img_path, f'{save_path}/result2.png')


def get_params():
    params = {
        'weight': r'C:\Users\admin\Desktop\hao_yolo\yolov5-master\runs\train\irmb\weights\best.pt',
        'device': 'cuda:0',
        'method': 'RandomCAM',
...
if __name__ == '__main__':
    ...
    model(r'C:\Users\admin\Desktop\hao_yolo\yolov5-master\road.jpg', 'images')